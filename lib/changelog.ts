...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    date: "2026-08",
    tag: "Wiki",
    text: "Une page de wiki se commente. Sélectionnez un passage — un mot, une phrase, un paragraphe — et un bouton « Commenter » apparaît. Le passage est surligné dans le texte, et la colonne de droite réunit les fils : on y répond, et on marque un fil comme résolu quand la question est tranchée. Un clic sur un surlignage amène son fil, un clic sur un fil ramène à son passage.\nLes commentaires survivent à la réécriture de la page : ils retiennent le passage visé et son voisinage, et se replacent tout seuls quand le texte bouge autour. Quand un passage commenté disparaît pour de bon, son fil n’est pas raccroché au hasard — il passe en fin de liste, marqué « détachée », et reste lisible.\nIls arrivent en temps réel : deux personnes qui relisent la même page se voient écrire."
  },
  {
    date: "2026-08",
    tag: "Personas",
