...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    category: "Interface",
    area: "Monde",
    text: "La chronologie d’un monde devient une frise verticale : les années en très grands chiffres, un fil, et pour chaque salon un anneau, son titre puis sa date, un filet à chaque changement de mois, son nom posé dessus en capitales. Un trait rouge plein, du fil jusqu’au bord, marque la date actuelle du monde et la frise s’ouvre sur son année ; au-delà de cinq ans, des pastilles mènent à chaque période.",
  },
  {
    date: "2026-09",
