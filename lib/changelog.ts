...
export const CHANGELOG: ChangelogEntry[] = [
  // ── 2026-09 ──────────────────────────────────────────────────────────────
  {
    ...
    area: "Monde",
    text: "La chronologie raconte le monde : des événements datés sans salon (un losange sur le fil, avec leur texte et une page du wiki), des arcs narratifs qui teintent leurs salons et les numérotent (« 1. », « 2. »…) dans l’ordre du récit, des lignes qui relient un salon à sa suite (en rail continu ou en graphe à côté du fil, tracées en permanence ou au survol seulement, au choix de chacun dans les filtres), et, si le monde le veut, les journaux des personas. Une recherche et des filtres (type, persona présent, joueur, arc, catégorie) la parcourent ; les saisons du monde remplacent les tranches de cinq ans. Une nouvelle permission, « Gérer la chronologie », confie les événements et les arcs. L’arc d’un salon et le salon dont il est la suite se choisissent dans ses réglages ; les saisons et l’affichage des journaux, dans ceux de la chronologie.",
  },
  {
    date: "2026-09-26",
    category: "Correctif",
  ...
  },
  {
    ...
    category: "Interface",
    area: "Monde",
    text: "La chronologie d’un monde devient une frise verticale : les années en très grands chiffres, un fil, et pour chaque salon un anneau sur le fil ; le jour d’une date s’écrit une fois, à gauche du fil, et le mois sur son filet — « par Persona (@pseudo) », le persona dans la couleur de son groupe —, un filet pointillé à chaque changement de mois, son nom posé dessus en capitales. Un trait rouge plein, du fil jusqu’au bord, marque la date actuelle du monde et la frise s’ouvre sur son année ; au-delà de cinq ans, des pastilles mènent à chaque période.",
  },
  {
    date: "2026-09",
    category: "Fonctionnalité",
