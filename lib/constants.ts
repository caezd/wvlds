...
export const TABLE = {
  ...
  CHATROOM_CATEGORIES: "chatroom_categories",
  WORLD_TIMELINE_EVENTS: "world_timeline_events",
  WORLD_TIMELINE_ARCS: "world_timeline_arcs",
  CHATROOM_SEQUELS: "chatroom_sequels",
  WORLD_WIKI_PAGES: "world_wiki_pages",
...
export const RPC = {
  ...
  ACCEPT_PERSONA_RELATION: "accept_persona_relation",
  ...
  SUBMIT_PERSONA_FOR_REVIEW: "submit_persona_for_review",
