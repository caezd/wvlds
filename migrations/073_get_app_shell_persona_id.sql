-- ============================================================
-- Migration 073 — get_app_shell() : inclure persona_id des notifications
-- ============================================================
-- 072_persona_follows a ajouté notifications.persona_id, mais get_app_shell()
-- construit la ligne à la main via jsonb_build_object() (pas de SELECT *) :
-- sans ce correctif, le persona_id serait silencieusement absent des
-- notifications chargées au bootstrap.
