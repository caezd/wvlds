...
describe("WorldHome — titre/description hors bannière + panel de contenu", () => {
  ...
  it("affiche les statistiques sous le titre quand le widget est activé, hors du panel", async () => {
    render(
    ...
    // Les deux existent, mais stats n'est pas un descendant du même conteneur que grid (le panel).
    const panel = grid.closest("[data-home-panel]");
