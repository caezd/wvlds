      ...
      {items.map((item) => (
        ...
        >
          ...
          <button
            ...
            className="shrink-0 text-muted-foreground opacity-100 sm:opacity-0 sm:group-hover/trait:opacity-100 sm:focus-within:opacity-100 hover:text-destructive transition-opacity"
          >
            <X className="h-3 w-3" />
          </button>
        </div>
