          ...
          <div className="flex-1 space-y-1 pb-4 min-w-0">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="shrink-0 h-5 w-5 flex items-center justify-center rounded-full text-muted-foreground opacity-100 sm:opacity-0 sm:group-hover/event:opacity-100 sm:focus-within:opacity-100 hover:text-destructive transition-opacity"
              >
