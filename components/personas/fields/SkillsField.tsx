        ...
        {items.map((item) => (
          <div key={item.id} className="flex items-center gap-2 group/skill">
            ...
            <button
              ...
              className="shrink-0 h-5 w-5 flex items-center justify-center rounded-full text-muted-foreground opacity-0 group-hover/skill:opacity-100 focus-within:opacity-100 hover:text-destructive transition-opacity"
            >
      ...
      {items.map((item) => (
        <div key={item.id} className="flex items-start gap-2 group/skill">
          ...
          <button
            ...
            type="button"
            onClick={() => removeItem(item.id)}
            className="shrink-0 mt-2.5 h-5 w-5 flex items-center justify-center rounded-full text-muted-foreground opacity-0 group-hover/skill:opacity-100 focus-within:opacity-100 hover:text-destructive transition-opacity"
          >
            <X className="h-3.5 w-3.5" />
          </button>
        </div>
