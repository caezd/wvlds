      ...
      <div className="relative flex h-full w-full flex-row">
        ...
        */}
        ...
        {notificationsEnabled && (
          <div
            className={cn("shrink-0 h-full overflow-hidden transition-[width] duration-300 ease-in-out max-lg:hidden", notifPanelOpen && "border-l border-border-soft")}
        ...
        <section id="app-shell" className="relative flex h-full max-w-full flex-1 flex-col py-3 pr-3 pl-0 max-lg:p-2 max-lg:pt-0">
