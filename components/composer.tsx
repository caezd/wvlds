export default function Composer() {
    return (
        <form action="" className="group/composer w-full">
            <div>
                <div className="bg-card-400 cursor-text overflow-clip bg-clip-padding p-2.5 contain-inline-size grid grid-cols-[auto_1fr_auto] [grid-template-areas:'header_header_header'_'primary_primary_primary'_'leading_footer_trailing'] shadow rounded-[28px]">
